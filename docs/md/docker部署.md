...
```
wget https://gitee.com/kye-galaxy-bigdata/chitu-sdp/raw/master/docs/deploy/docker.tar.gz
...
wget https://gitee.com/kye-galaxy-bigdata/chitu-sdp/raw/master/docs/deploy/sqlclient/chitu-sdp-flink-sqlclient-1.14-1.0.0-SNAPSHOT.jar
wget https://gitee.com/kye-galaxy-bigdata/chitu-sdp/raw/master/docs/deploy/sqlclient/chitu-sdp-flink-sqlclient-1.15-1.0.0-SNAPSHOT.jar
